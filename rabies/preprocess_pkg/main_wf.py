...
from .utils import BIDSDataGraber, extract_entities, prep_bids_iter, convert_to_RAS, resample_template,BIDSDataGraberSingleEcho,remove_echo_string,extract_first_element,extract_te_from_json
...
def init_main_wf(data_dir_path, output_folder, opts, name='main_wf'):
    ...
    **Outputs**
    ...
    num_echoes = max((int(i) for sublist in echo_iter.values() for i in sublist if i is not None), default=0)
    ...
    # Create a node to convert input image to consistent RAS orientation
