...
def init_main_wf(data_dir_path, output_folder, opts, name='main_wf'):
    ...
    **Outputs**
    ...
    '''
    subsequent_echo = pe.Node(Function(input_names=["echo_dict", "run_id"],
                                        output_names=["echo","run_id"],
                                        function=get_subsequent_echo),
                                name="subsequent_echo")
    subsequent_echo.inputs.echo_dict = echo_iter
    '''
